...
description:
  Open OPPA and pre-fill pairing details from a URL, QR code, or
  server dashboard.
---
...
When OPPA has no active server, the dialog appears immediately and the
user can review the server URL, set their agent name, and pair.
