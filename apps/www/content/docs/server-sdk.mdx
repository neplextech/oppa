...
For a managed implementation of the same public boundary, see
[Neplex OpenPrinter Cloud](/cloud). The open-source server SDK and
self-hosting path are completely free; managed pricing only applies to
the Neplex cloud API.
